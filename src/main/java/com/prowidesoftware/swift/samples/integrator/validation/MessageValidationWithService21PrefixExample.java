...
public class MessageValidationWithService21PrefixExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String fin =
                "{1:F21FOOLHKH0AXXX0000000000}{4:{177:1608140809}{451:0}}{1:F01FOOLHKH0AXXX0000000000}{2:O9401609160814FOOLHKH0AXXX00000000001608141609N}{4:\n"
                        + ":20:USD940NO1\n"
                        + ":21:123456/DEV\n"
                        + ":25:USD234567\n"
                        + ":28C:1/1\n"
                        ...
                        + ":62F:C160418USD1872,\n"
                        + ":64:C160418USD1872,\n"
                        + "-}{5:{CHK:555555555555}{TNG:}}{S:{COP:S}}";
