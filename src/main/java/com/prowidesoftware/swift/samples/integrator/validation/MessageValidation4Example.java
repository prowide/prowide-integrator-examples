...
public class MessageValidation4Example {
    ...
    static final String mt540_ok = "{1:F01FOOLUS30AXXX0000000000}{2:I540FOOSGB20XGSTN}{3:{108:00000000000007}}{4:\n" +

            // General Information
            ":16R:GENL\n"
            + // 0
            ":20C::SEME//00000000000007\n"
            + // 1
            ":23G:NEWM\n"
            + // 2
            ":16S:GENL\n"
            ...
            + // 25
            "-}";
    static final String mt540_errors =
            "{1:F01AAAAUS00AXXX0000000000}{2:I540BBBBUS00XGSTN}{3:{108:00000000000008}}{4:\n" +

                    // General Information
                    ":16R:GENL\n"
                    + ":20C::SEME//00000000000008\n"
                    + ":23G:NEWM\n"
                    + ":16S:GENL\n"
                    +
