...
public class MxMtTranslationExample3 {
    ...
    private static final String xml =
            "<Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"urn:swift:xsd:envelope\"\n"
                    ...
                    + "            </FIId>\n"
                    + "        </To>\n"
                    + "        <BizMsgIdr>FOO0000000001</BizMsgIdr>\n"
                    ...
                    + "            <CdtTrfTxInf>\n"
                    + "                <PmtId>\n"
                    + "                    <InstrId>FOO0000000001</InstrId>\n"
                    + "                    <EndToEndId>FOO0000000000002</EndToEndId>\n"
                    ...
                    + "                </Cdtr>\n"
                    + "                <RmtInf>\n"
                    + "                    <Ustrd>Sample remittance reference</Ustrd>\n"
                    + "                </RmtInf>\n"
                    + "            </CdtTrfTxInf>\n"
                    + "        </FICdtTrf>\n"
                    + "    </Document>\n"
