...
public class Mx2CsvExample {
    public static void main(String[] args) {
        ...
        t.add(new MappingRule(
                "FOREACH(/Document/CstmrCdtTrfInitn/PmtInf/CdtTrfTxInf, \",,,\")", "addRow", WriteMode.SETUP));
        ...
        t.add(new MappingRule(
                "foreach(/Document/CstmrCdtTrfInitn/PmtInf/CdtTrfTxInf[{m}]/, ../DbtrAcct/Id/IBAN)", "0"));

        // group by PmtInf DbtrAcct
        t.add(new MappingRule("foreach(/Document/CstmrCdtTrfInitn/PmtInf[n]/DbtrAcct/Id/IBAN)", "0"));
        t.add(new MappingRule(
                "foreach(/Document/CstmrCdtTrfInitn/PmtInf[n:/DbtrAcct/Id/IBAN]/CdtTrfTxInf[m]/CdtrAcct/Id/IBAN)",
                "1"));
        t.add(new MappingRule(
                "foreach(/Document/CstmrCdtTrfInitn/PmtInf[n:/DbtrAcct/Id/IBAN]/CdtTrfTxInf[m]/Amt/InstdAmt)", "2"));
        t.add(new MappingRule(
                "foreach(/Document/CstmrCdtTrfInitn/PmtInf[n:/DbtrAcct/Id/IBAN]/CdtTrfTxInf[m]/Amt/InstdAmt/@Ccy)",
                "3"));
