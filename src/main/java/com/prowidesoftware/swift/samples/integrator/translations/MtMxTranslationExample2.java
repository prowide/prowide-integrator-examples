...
public class MtMxTranslationExample2 {
    ...
    public static final String sample =
            "{1:F01SFOOBEB00XXX0001000001}{2:I564SFOOBEB0XBILN}{3:{108:495}}{4:\n" + ":16R:GENL\n"
                    + ":20C::CORP//FOOBAR\n"
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // IF ((B2[*]\97a Account\SAFE\97C\Account Code ContainsString 'GENR') And ((B2[*]\95a Party\ACOW IsPresent)
            // Or ((B2[*]\94a Place\SAFE IsPresent) Or (B2[*]\93a Balance IsPresent))))
            ...
            if (p.isEmpty()) {
                 ...
                 */
                System.out.println("Cancellation Reason Code: "
                        + mx.getCorpActnCxlAdvc()
                                .getCxlAdvcGnlInf()
                                .getCxlRsnCd()
                                .name());
                System.out.println("Processing Completness: "
                        + mx.getCorpActnCxlAdvc()
                                .getCxlAdvcGnlInf()
                                .getPrcgSts()
                                .getEvtSts()
                                .getEvtCmpltnsSts()
                                .name());
                System.out.println("Corporate Action Id: "
                        + mx.getCorpActnCxlAdvc().getCorpActnGnlInf().getCorpActnEvtId());
                System.out.println("Event Type Code: "
                        + mx.getCorpActnCxlAdvc()
                                .getCorpActnGnlInf()
                                .getEvtTp()
                                .getCd()
                                .name());
                System.out.println("Underlying Security ISIN: "
                        + mx.getCorpActnCxlAdvc()
                                .getCorpActnGnlInf()
                                .getUndrlygSctyId()
                                .getISIN());
