 ...
 *
 * <p>This is the reverse of {@link Json2MtExample4}, and the sequenced (ISO 15022) counterpart of
 * {@link Mt2JsonExample1}, which uses a simpler MT202 with no sequences.
 *
...
public class Mt2JsonExample2 {
    ...
    public static void main(String[] args) {
        ...
        t.add(new MappingRule(
                "B2/93B/ELIG/5", "corporateAction.security.eligibleBalance", new Transformation(Key.formatDecimal)));
        ...
        t.add(new MappingRule(
                "E2/19B/ENTL/3", "corporateAction.options[1].grossAmount", new Transformation(Key.formatDecimal)));
