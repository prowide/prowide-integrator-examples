...
/**
 * Same conversion as {@link Mx2JsonExample1}, but the RELATIVE sheet of
 * {@code /myformat/mx2json.xls} writes the source selectors with the {@code //} shorthand:
 * {@code //CstmrCdtTrfInitn/GrpHdr/MsgId}, {@code //GrpHdr/NbOfTxs}, or just {@code //CtrlSum}.
 *
 * <p>The shorthand matches the element anywhere in the document, so you only need to spell out as
 * much of the path as is required to make it unambiguous. The mapping result is identical to the
 * absolute form; this is purely a matter of how much of the hierarchy you want to write down. The
 * same shorthand applies to the FOREACH style of {@link Mx2JsonExample3}, shown in the
 * FOREACH_REL sheet.
 *
 * <p>Requires the Prowide Integrator MyFormat module.
 */
public class Mx2JsonExample2 {
    ...
    public static void main(String[] args) {
        ...
        MappingTableExcelLoader loader = new MappingTableExcelLoader(
                Objects.requireNonNull(Mx2JsonExample2.class.getResourceAsStream("/myformat/mx2json.xls")));
