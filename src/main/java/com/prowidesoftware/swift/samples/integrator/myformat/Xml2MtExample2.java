...
public class Xml2MtExample2 {
    ...
    public static void main(String[] args) {
        ...
        MappingTableExcelLoader loader = new MappingTableExcelLoader(
                Objects.requireNonNull(Xml2MtExample2.class.getResourceAsStream("/myformat/xml2mt.xls")));
        ...
        final String source = "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\n"
                ...
                + "            Bk=\"FOO\" Ccy=\"USD\" CntCcy=\"ZAR\" CntLastQty=\"+100000000.00\" DealingInf=\"FOO\" ExecTyp=\"0\" LastMkt=\"10.000\"\n"
                + "            LastPx=\"10.00\" LastQty=\"+10000000.00\" ManQuot=\"1\" MsgID=\"0000000001\" SettlDt=\"2019-01-03\" TrdDt=\"2019-01-01\"\n"
                + "            TrdID=\"FOO0000001\" TrdID2=\"000001\"\n"
                + "            xsi:schemaLocation=\"http://www.fixprotocol.org/FIXML-5-0-SP1 fixml-tradecapture-base-5-0-SP1.xsd\">\n"
                + "    <Hdr Snt=\"2019-01-01T00:00:00\"/>\n"
                + "    <Instrmt CFI=\"RCSXXX\" SubTyp=\"SP\" Sym=\"USD/ZAR\"/>\n"
                + "    <Undly ChlMgn=\"0.0\" CxMktPts=\"0.0\" Desc=\"SP\" FxRate=\"10.00\" Mat=\"2019-01-03\" MktFxRate=\"10.000\" Px=\"-0.0100\"\n"
                + "           QteBas=\"0\" RateUids=\"-1\" RevalRate=\"1.0\" Sym=\"USD/ZAR\"/>\n"
                + "    <RptSide Side=\"1\">\n"
                + "        <Pty ID=\"Joe Doe\" R=\"11\"/>\n"
                + "        <Pty ID=\"FOO INVESTMENTS     LRG\" R=\"13\"/>\n"
                + "        <Pty ID=\"10000\" R=\"3\"/>\n"
                + "        <Pty ID=\"FOO\" R=\"31\"/>\n"
                + "        <Pty ID=\"FOO\" R=\"53\"/>\n"
                + "        <Pty R=\"87\"/>\n"
